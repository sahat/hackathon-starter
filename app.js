...
app.get('/auth/facebook', passport.authenticate('facebook', { scope: ['email', 'user_location', 'publish_actions', 'read_insights', 'pages_show_list', 'public_profile', 'manage_pages'] }));
