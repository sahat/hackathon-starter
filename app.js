...
const tradingSignalController = require('./controllers/signal');
...
app.get('/tradingSignals', tradingSignalController.getTradingSignals);
app.post('/tradingSignals', tradingSignalController.postTradingSignals);
