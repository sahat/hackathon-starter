...
!(function (a, b) {
  ...
  let c = [],
    ...
    now: Date.now,
    support: o }), typeof Symbol === 'function' && (r.fn[Symbol.iterator] = c[Symbol.iterator]), r.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), (a, b) => { j[`[object ${b}]`] = b.toLowerCase(); }); function w(a) {
    ...
    let b,
      ...
      preFilter: { ATTR(a) { return a[1] = a[1].replace(_, aa), a[3] = (a[3] || a[4] || a[5] || '').replace(_, aa), a[2] === '~=' && (a[3] = ` ${a[3]} `), a.slice(0, 4); },
      ...
      filter: { TAG(a) { const b = a.replace(_, aa).toLowerCase(); return a === '*' ? function () { return !0; } : function (a) { return a.nodeName && a.nodeName.toLowerCase() === b; }; },
      ...
      gt: pa((a, b, c) => { for (let d = c < 0 ? c + b : c; ++d < b;)a.push(d); return a; }) } }, d.pseudos.nth = d.pseudos.eq; for (b in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })d.pseudos[b] = ma(b); for (b in { submit: !0, reset: !0 })d.pseudos[b] = na(b); function ra() {}ra.prototype = d.filters = d.pseudos, d.setFilters = new ra(), g = ga.tokenize = function (a, b) {
      let c,
        e,
        f,
        g,
  ...
  is(a) { return !!D(this, typeof a === 'string' && A.test(a) ? r(a) : a || [], !1).length; } }); let E,
    F = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
    ...
    I = { children: !0, contents: !0, next: !0, prev: !0 }; r.fn.extend({ has(a) {
    let b = r(a, this),
  ...
  }; function M(a) { return a; } function N(a) { throw a; } function O(a, b, c) { let d; try { a && r.isFunction(d = a.promise) ? d.call(a).done(b).fail(c) : a && r.isFunction(d = a.then) ? d.call(a, b, c) : b.call(void 0, a); } catch (a) { c.call(void 0, a); } }r.extend({ Deferred(b) {
  ...
  when(a) {
  ...
  } }); const P = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/; r.Deferred.exceptionHook = function (b, c) { a.console && a.console.warn && b && P.test(b.name) && a.console.warn(`jQuery.Deferred exception: ${b.message}`, b.stack, c); }, r.readyException = function (b) { a.setTimeout(() => { throw b; }); }; const Q = r.Deferred(); r.fn.ready = function (a) { return Q.then(a).catch((a) => { r.readyException(a); }), this; }, r.extend({ isReady: !1, readyWait: 1, holdReady(a) { a ? r.readyWait++ : r.ready(!0); }, ready(a) { (a === !0 ? --r.readyWait : r.isReady) || (r.isReady = !0, a !== !0 && --r.readyWait > 0 || Q.resolveWith(d, [r])); } }), r.ready.then = Q.then; function R() {
    ...
    T = function (a) { return a.nodeType === 1 || a.nodeType === 9 || !+a.nodeType; }; function U() { this.expando = r.expando + U.uid++; }U.uid = 1, U.prototype = { cache(a) { let b = a[this.expando]; return b || (b = {}, T(a) && (a.nodeType ? a[this.expando] = b : Object.defineProperty(a, this.expando, { value: b, configurable: !0 }))), b; },
    set(a, b, c) {
      let d,
    ...
    hasData(a) { const b = a[this.expando]; return void 0 !== b && !r.isEmptyObject(b); } }; let V = new U(),
    W = new U(),
    X = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
    Y = /[A-Z]/g; function Z(a) { return a === 'true' || a !== 'false' && (a === 'null' ? null : a === `${+a}` ? +a : X.test(a) ? JSON.parse(a) : a); } function $(a, b, c) { let d; if (void 0 === c && a.nodeType === 1) if (d = `data-${b.replace(Y, '-$&').toLowerCase()}`, c = a.getAttribute(d), typeof c === 'string') { try { c = Z(c); } catch (e) {}W.set(a, b, c); } else c = void 0; return c; }r.extend({ hasData(a) { return W.hasData(a) || V.hasData(a); }, data(a, b, c) { return W.access(a, b, c); }, removeData(a, b) { W.remove(a, b); }, _data(a, b, c) { return V.access(a, b, c); }, _removeData(a, b) { V.remove(a, b); } }), r.fn.extend({ data(a, b) {
    let c,
      d,
      e,
      f = this[0],
  ...
  removeData(a) { return this.each(function () { W.remove(this, a); }); } }), r.extend({ queue(a, b, c) { let d; if (a) return b = `${b || 'fx'}queue`, d = V.get(a, b), c && (!d || r.isArray(c) ? d = V.access(a, b, r.makeArray(c)) : d.push(c)), d || []; },
    dequeue(a, b) {
    ...
    _queueHooks(a, b) { const c = `${b}queueHooks`; return V.get(a, c) || V.access(a, c, { empty: r.Callbacks('once memory').add(() => { V.remove(a, [`${b}queue`, c]); }) }); } }), r.fn.extend({ queue(a, b) { let c = 2; return typeof a !== 'string' && (b = a, a = 'fx', c--), arguments.length < c ? r.queue(this[0], a) : void 0 === b ? this : this.each(function () { const c = r.queue(this, a, b); r._queueHooks(this, a), a === 'fx' && c[0] !== 'inprogress' && r.dequeue(this, a); }); },
  ...
  }), r.fn.extend({ on(a, b, c, d) { return xa(this, a, b, c, d); },
  ...
  } function Ja(a, b, c) { for (var d, e = b ? r.filter(b, a) : a, f = 0; (d = e[f]) != null; f++)c || d.nodeType !== 1 || r.cleanData(ma(d)), d.parentNode && (c && r.contains(d.ownerDocument, d) && na(ma(d, 'script')), d.parentNode.removeChild(d)); return a; }r.extend({ htmlPrefilter(a) { return a.replace(ya, '<$1></$2>'); },
    clone(a, b, c) {
      let d,
        e,
        f,
    ...
    cleanData(a) { for (var b, c, d, e = r.event.special, f = 0; void 0 !== (c = a[f]); f++) if (T(c)) { if (b = c[V.expando]) { if (b.events) for (d in b.events)e[d] ? r.event.remove(c, d) : r.removeEvent(c, d, b.handle); c[V.expando] = void 0; }c[W.expando] && (c[W.expando] = void 0); } } }), r.fn.extend({ detach(a) { return Ja(this, a, !0); },
    ...
    replaceWith() { const a = []; return Ia(this, arguments, function (b) { const c = this.parentNode; r.inArray(this, a) < 0 && (r.cleanData(ma(this)), c && c.replaceChild(b, this)); }, a); } }), r.each({ appendTo: 'append', prependTo: 'prepend', insertBefore: 'before', insertAfter: 'after', replaceAll: 'replaceWith' }, (a, b) => { r.fn[a] = function (a) { for (var c, d = [], e = r(a), f = e.length - 1, g = 0; g <= f; g++)c = g === f ? this : this.clone(!0), r(e[g])[b](c), h.apply(d, c.get()); return this.pushStack(d); }; }); let Ka = /^margin/,
  ...
  }r.extend({ cssHooks: { opacity: { get(a, b) { if (b) { const c = Na(a, 'opacity'); return c === '' ? '1' : c; } } } },
  ...
  } }); function Ya(a, b, c, d, e) { return new Ya.prototype.init(a, b, c, d, e); }r.Tween = Ya, Ya.prototype = { constructor: Ya,
    ...
    } }), r.each(['toggle', 'show', 'hide'], (a, b) => { const c = r.fn[b]; r.fn[b] = function (a, d, e) { return a == null || typeof a === 'boolean' ? c.apply(this, arguments) : this.animate(db(b, !0), a, d, e); }; }), r.each({ slideDown: db('show'), slideUp: db('hide'), slideToggle: db('toggle'), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' } }, (a, b) => { r.fn[a] = function (a, c, d) { return this.animate(b, a, c, d); }; }), r.timers = [], r.fx.tick = function () {
    let a,
      b = 0,
    ...
    jb = r.expr.attrHandle; r.fn.extend({ attr(a, b) { return S(this, r.attr, a, b, arguments.length > 1); }, removeAttr(a) { return this.each(function () { r.removeAttr(this, a); }); } }), r.extend({ attr(a, b, c) {
    let d,
      e,
  ...
  removeAttr(a, b) {
    ...
    lb = /^(?:a|area)$/i; r.fn.extend({ prop(a, b) { return S(this, r.prop, a, b, arguments.length > 1); }, removeProp(a) { return this.each(function () { delete this[r.propFix[a] || a]; }); } }), r.extend({ prop(a, b, c) {
    let d,
      e,
  ...
  hasClass(a) {
  ...
  } }), r.extend({ valHooks: { option: { get(a) { const b = r.find.attr(a, 'value'); return b != null ? b : mb(r.text(a)); } },
    select: { get(a) {
      let b,
        c,
        d,
    ...
    } } } }), r.each(['radio', 'checkbox'], function () { r.valHooks[this] = { set(a, b) { if (r.isArray(b)) return a.checked = r.inArray(r(a).val(), b) > -1; } }, o.checkOn || (r.valHooks[this].get = function (a) { return a.getAttribute('value') === null ? 'on' : a.value; }); }); const pb = /^(?:focusinfocus|focusoutblur)$/; r.extend(r.event, { trigger(b, c, e, f) {
    let g,
      h,
      i,
      j,
  ...
  simulate(a, b, c) { const d = r.extend(new r.Event(), c, { type: a, isSimulated: !0 }); r.event.trigger(d, null, b); } }), r.fn.extend({ trigger(a, b) { return this.each(function () { r.event.trigger(a, b, this); }); }, triggerHandler(a, b) { const c = this[0]; if (c) return r.event.trigger(a, b, c, !0); } }), r.each('blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu'.split(' '), (a, b) => { r.fn[b] = function (a, c) { return arguments.length > 0 ? this.on(b, null, a, c) : this.trigger(b); }; }), r.fn.extend({ hover(a, b) { return this.mouseenter(a).mouseleave(b || a); } }), o.focusin = 'onfocusin' in a, o.focusin || r.each({ focus: 'focusin', blur: 'focusout' }, (a, b) => {
    ...
    getScript(a, b) { return r.get(a, void 0, b, 'script'); } }), r.each(['get', 'post'], (a, b) => { r[b] = function (a, c, d, e) { return r.isFunction(c) && (e = e || d, d = c, c = void 0), r.ajax(r.extend({ url: a, type: b, dataType: e, data: c, success: d }, r.isPlainObject(a) && a)); }; }), r._evalUrl = function (a) { return r.ajax({ url: a, type: 'GET', dataType: 'script', cache: !0, async: !1, global: !1, throws: !0 }); }, r.fn.extend({ wrapAll(a) { let b; return this[0] && (r.isFunction(a) && (a = a.call(this[0])), b = r(a, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && b.insertBefore(this[0]), b.map(function () { let a = this; while (a.firstElementChild)a = a.firstElementChild; return a; }).append(this)), this; },
    wrapInner(a) {
    ...
    let d,
      ...
      f,
      g = this,
      h = a.indexOf(' '); return h > -1 && (d = mb(a.slice(h)), a = a.slice(0, h)), r.isFunction(b) ? (c = b, b = void 0) : b && typeof b === 'object' && (e = 'POST'), g.length > 0 && r.ajax({ url: a, type: e || 'GET', dataType: 'html', data: b }).done(function (a) { f = arguments, g.html(d ? r('<div>').append(r.parseHTML(a)).find(d) : a); }).always(c && ((a, b) => { g.each(function () { c.apply(this, f || [a.responseText, b, a]); }); })), this;
  }, r.each(['ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend'], (a, b) => { r.fn[b] = function (a) { return this.on(b, a); }; }), r.expr.pseudos.animated = function (a) { return r.grep(r.timers, b => a === b.elem).length; }; function Sb(a) { return r.isWindow(a) ? a : a.nodeType === 9 && a.defaultView; }r.offset = { setOffset(a, b, c) {
    let d,
      e,
      f,
      g,
  ...
  }), r.fn.extend({ bind(a, b, c) { return this.on(a, null, b, c); }, unbind(a, b) { return this.off(a, null, b); }, delegate(a, b, c, d) { return this.on(b, a, c, d); }, undelegate(a, b, c) { return arguments.length === 1 ? this.off(a, '**') : this.off(b, a || '**', c); } }), r.parseJSON = JSON.parse, typeof define === 'function' && define.amd && define('jquery', [], () => r); let Tb = a.jQuery,
