...
module.exports = {
  ...
  db: process.env.MONGOLAB_URI || process.env.MONGODB || (process.env.MONGODB_PORT_27017_TCP) ? 'mongodb://' + process.env.MONGODB_PORT_27017_TCP_ADDR + ':' + process.env.MONGODB_PORT_27017_TCP_PORT + '/test' : 'mongodb://localhost:27017/test',
